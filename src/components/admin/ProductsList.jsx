  ...
  return (
    <>
      <main className=" py-10 lg:pl-72">
        {props.showAlert && (
          <div
            className="mt-4 mx-8 top-0 right-0 fixed sm:px-6 lg:px-8 bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded"
            role="alert"
          >
            <strong className="font-bold"></strong>
            <span className="block mx-2 sm:inline">
              {" "}
            ...
            <div className="sm:flex sm:items-center">
              <div className="sm:flex-auto">
                ...
                <p className="mt-2 text-sm text-gray-700">
                  ...
                  title, category, size and status.
                </p>
              </div>
                        ...
                        <tr key={product._id}>
                          ...
                          <td className="relative whitespace-nowrap py-5 pl-3 pr-4 text-right text-sm font-medium sm:pr-0">
                            <button
                              ...
                              onClick={() =>
                                props.deleteProductById(product._id)
                              }
                            >
